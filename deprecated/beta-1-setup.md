...
- [OpenShift Beta 1 Setup Information](#openshift-beta-1-setup-information)
  ...
  - [Setting Up the Environment](#setting-up-the-environment)
    ...
    - [Git](#git)
    - [Each VM](#each-vm)
    - [Grab Docker Images](#grab-docker-images)
    - [Clone the Training Repository](#clone-the-training-repository)
    - [REMINDER](#reminder)
  - [Starting the OpenShift Services](#starting-the-openshift-services)
    - [Running a Master](#running-a-master)
  ...
  - [Your First Application](#your-first-application)
    - [Set the namespace (project) you are using](#set-the-namespace-project-you-are-using)
    - [The Definition JSON](#the-definition-json)
  ...
  - [Adding Nodes](#adding-nodes)
    ...
    - [Adding the Node Via OpenShift's API](#adding-the-node-via-openshifts-api)
  - [Services](#services)
  - [Routing](#routing)
  ...
  - [STI - What Is It?](#sti---what-is-it)
    ...
    - [A Fully-Integrated Application](#a-fully-integrated-application)
    - [Creating the Integrated Application](#creating-the-integrated-application)
    - [Routing Our Integrated Application](#routing-our-integrated-application)
